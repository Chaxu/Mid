    ...
    <div class="col pull-left " style="margin-top:30px;">
        <div class="panel panel-default">
            <div class="panel-heading bg-info">
                <h3 class="text-white"><i class="fa fa-plus"></i><strong>Add New Result</strong></h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" method="post" action="result.jsp" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="pwd"><strong>Branch </strong></label>
                        <div class="col-sm-8">
                            <select class=form-control name="branch"><br>
...
<option value="Textile Engineering">Textile Engineering</option>
        ...
        <option value="8th" >8th</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="" placeholder="Enter Subject Name" name="sub" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="pwd"><strong>Division</strong></label>
                        <div class="col-sm-8">
                            <input type="text"   class="form-control" id="" placeholder="Enter Division Name" name="division" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class=form-control name="exam">
                               ...
                               <option value="remid" >Remid Exam</option>
                            </select>

                        </div>
                    </div>
                     <div class="form-group">
                        <label class="control-label col-sm-2" for="pwd"><strong>Faculty Name</strong></label>
                        <div class="col-sm-8">
                            <input type="text"   class="form-control" id="" placeholder="Enter Faculty Name" name="name" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="pwd"><strong>Result</strong></label>
                        <div class="col-sm-8">
                            <div class="col-lg-">
                                <input type="file" class="form-control" name="f1" style="padding: 10px; border:none;">
                            </div>
                        </div>
                    </div>


                    <button type="submit" name="submit" class="btn btn-success pull-right btn-xl" style="border-radius:0px;">Submit <i class="fa fa-arrow-right"></i></button>
                    <br><br>
                </form>
            </div>
        </div>
   ...
   <?php
    ...
    move_uploaded_file($_FILES["f1"]["tmp_name"],$dst); 
     ...
     mysqli_query($con,"insert into result               values('','$_POST[branch]','$_POST[sem]','$_POST[sub]','$_POST[division]','$_POST[exam]','$dst1'));
     }
    ...
    <div class="col-md-7 pull-right " style="margin-top:30px;">
        <div class="panel panel-default">
            <div class="panel-heading bg-success">
                <h3 class="text-white"><i class="fa fa-user-circle-o"></i><strong>Result</strong></h3>
                <!--
