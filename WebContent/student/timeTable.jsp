    ...
    <div class="col pull-left " style="margin-top:30px;">
        <div class="panel panel-default">
            <div class="panel-heading bg-info">
                <h3 class="text-white"><i class="fa fa-plus"></i><strong>Add New Time Table</strong></h3>
            </div>
...
<option value="Textile Engineering">Textile Engineering</option>
        ...
        <option value="8th">8th</option>
                    ...
                    <div class="form-group">
                            <label class="control-label col-sm-2" for="pwd"><strong>Time Table</strong></label>
                            <div class="col-sm-8">
                                <div class="col-lg-">
...
<div class="col-md-7 pull-right " style="margin-top:30px;">
    <div class="panel panel-default">
        <div class="panel-heading bg-success">
            <h3 class="text-white"><i class="fa fa-user-circle-o"></i><strong>Time Tables</strong></h3>
<!--
