        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.jsp">Mid Exam</a>
                </div>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="index.jsp" class="active"><i class="fa fa-dashboard fa-fw"></i> Profile</a>
                            </li>
                            
                            <li>
                                <a href="index.jsp" class="active"><i class="fa fa-dashboard fa-fw"></i> Logout</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default" style="padding-bottom:100px">
                            <div class="panel-heading">
                                <i class="fa fa-bar-chart-o fa-fw"></i> Posts
                                <div class="pull-right">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            ...
                                            <li><a href="#">One Week</a>
                                            </li>
                                            <li><a href="#">A While Ago</a>
                                            </li>
